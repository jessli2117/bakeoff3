...
String[] sets = {"abcd", "efgh", "ijkl", "mnop", "qrst", "uvwx", "yz_`"};
int currentSet = 0;
...
void draw()
{
  ...
  if (startTime!=0)
  {
    ...
    //next set +1
    fill(0); //lower right
    text("+", width/2-sizeOfInputArea/2+sizeOfInputArea/2+50+20,height/2-sizeOfInputArea/2+sizeOfInputArea/2+10);
...
void mousePressed()
{
  ...
  if(didMouseClick(width/2-sizeOfInputArea/2,height/2-sizeOfInputArea/2+sizeOfInputArea/2-25, 50,50)){
    currentSet--;
    if (currentSet < 0){
      currentSet = sets.length-1;
    }
    
  } else if (didMouseClick(width/2-sizeOfInputArea/2+sizeOfInputArea/2+50,height/2-sizeOfInputArea/2+sizeOfInputArea/2-25, 50,50)){
    currentSet++;
    if (currentSet >= sets.length){
      currentSet = 0;
    }
