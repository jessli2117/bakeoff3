...
void draw()
{
  ...
  if (startTime!=0)
  {
    ...
    text(">", width/2-sizeOfInputArea/2+sizeOfInputArea/2+50+20,height/2+sizeOfInputArea/2-25);
   
    //next and previous set
    //delete
    fill(255);
    text("DEL", width/2-sizeOfInputArea/2,height/2-sizeOfInputArea/2+25);
    
    //space
    fill(255); //lower right
    text("SPC", width/2-sizeOfInputArea/2+sizeOfInputArea/2+50,height/2-sizeOfInputArea/2+25);
...
void mousePressed()
{
  ...
  if(didMouseClick(width/2-sizeOfInputArea/2,height/2-sizeOfInputArea/2, 50,50)){
